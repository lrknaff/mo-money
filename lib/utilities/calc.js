...
const Calc =  {
  ...
  federalIncomeTax: (annualSalary, annualBonus) => {
    return Calc.totalIncome(annualSalary, annualBonus) *
  ...
  totalCosts: (annualSalary, annualBonus, match401k, lunch, beer, milesToWork, healthInsurancePremium) => {
    ...
    let tStateTax = Calc.stateTax(annualSalary, annualBonus)
