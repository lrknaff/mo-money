const Calc = {
  ...
  netIncomeAndBenefits: (annualSalary, annualBonus, match401k, lunch, beer, milesToWork, healthInsurancePremium, city) => {
    ...
    let totalCosts = Calc.totalCosts(annualSalary, annualBonus, match401k, lunch, beer, milesToWork, healthInsurancePremium, city)
  ...
  costOfLivingCalculation: (annualSalary, annualBonus, match401k, lunch, beer, milesToWork, healthInsurancePremium, city) => {
    ...
    let totalAdjustedIncomeAndBenefits = Calc.netIncomeAndBenefits(annualSalary, annualBonus, match401k, lunch, beer, milesToWork, healthInsurancePremium, city)
